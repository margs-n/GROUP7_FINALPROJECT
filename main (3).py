...
#BOT TOKEN
#Token is automatically reset when this file is uploaded online. To activate the discord bot, please message the repository owner to obtain a new bot token. 
my_secret = 'ODczMzg1MzA3OTc2OTEyOTY2.YQ3pdA.Ow2isGww_N0iMEuhp0pLfPqRviM' #input new bot token here
